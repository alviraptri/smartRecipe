...
public class Quest3 extends AppCompatActivity {
    ...
    public void quest3of1(View view){
        ...
        url = "http://10.0.2.2/smartrecipe/input.php?id_user=" + id_user + "&id_question=3&answer=1";
    ...
    public void quest3of2(View view){
        ...
        SharedPreferences.Editor editor = pref.edit();
        int id_user = pref.getInt("id", 0);
        url = "http://10.0.2.2/smartrecipe/input.php?id_user=" + id_user + "&id_question=3&answer=2";
