...
public class Quest2 extends AppCompatActivity {
    ...
    public void quest2of1(View view){
        ...
        url = "http://10.0.2.2/smartrecipe/input.php?id_user=" + id_user + "&id_question=2&answer=1";
    ...
    public void quest2of2(View view){
        ...
        SharedPreferences.Editor editor = pref.edit();
        int id_user = pref.getInt("id", 0);
        url = "http://10.0.2.2/smartrecipe/input.php?id_user=" + id_user + "&id_question=2&answer=2";
    ...
    public void quest2of3(View view){
        ...
        SharedPreferences.Editor editor = pref.edit();
        int id_user = pref.getInt("id", 0);
        url = "http://10.0.2.2/smartrecipe/input.php?id_user=" + id_user + "&id_question=2&answer=3";
